...
local suits = {
    tile      = require("dynamic.suit.tile"      ),
    fair      = require("dynamic.suit.fair"      ),
    max       = require("dynamic.suit.max"       ),
    corner    = require("dynamic.suit.corner"    ),
    tree      = require("dynamic.suit.treesome"  ),
    magnifier = require("dynamic.suit.magnifier" ),
}
...
suits.register = require("dynamic.base").register
